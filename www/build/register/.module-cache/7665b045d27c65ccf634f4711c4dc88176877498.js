			...
			var RegisterComponent = React.createClass({displayName: "RegisterComponent",
			  render: function() {
                ...
                React.createElement("p", {className: "buttons-row"}, 
                  React.createElement("a", {href: "index.html", className: "button button-fill button-raised button-big color-green"}, "Sign in"), 
                  React.createElement("a", {href: "#", className: "button button-fill button-raised button-big color-indigo"}, "Sign up")
                )
                )
