		  ...
		  React.createElement("div", {className: "row"}, 
                    ...
                    React.createElement("div", {className: "col-100"}, 
                        React.createElement("center", null, 
                         React.createElement("i", {onClick: this.handleRecord, id: "re-record", className: "fa fa-video-camera fa-4x"}), 
								...
								React.createElement("video", {width: "100%", height: "267", id: "re-change-video", preload: "none", poster: "http://embed.ziggeo.com/v1/applications/ddd4366d3fc0baef95c333fa575c53f9/videos/"+(this.state.ziggeocode)+"/image", controls: true}, 
                    ...
                    React.createElement("div", {className: "col-100"}, 
                        React.createElement("div", {className: "item-input"}, 
                         React.createElement("input", {type: "text", placeholder: "Video Title", id: "re-video-title", value: this.state.title.replace(/^<div[^>]*>|<\/div>$/g, ''), className: "record-input"})
                        )
                    ), 
                    React.createElement("div", {className: "col-100"}, 
                        React.createElement("div", {className: "item-input"}, 
                            React.createElement("input", {type: "text", placeholder: "Hashtag", id: "re-autocomplete-user", value: this.state.hashtag.replace(/^<div[^>]*>|<\/div>$/g, ''), className: "record-input"})
                        )
