    ...
    return (
		  React.createElement("div", {className: "row"}, 
                    ...
                    React.createElement("div", {className: "col-50"}
                     ...
                     React.createElement("div", {className: "col-50"}, 
                        React.createElement("button", {id: "re-aw-whats-new-submit", className: "button button-fill lightgreen", style: {width:'100%'}}, React.createElement("i", {className: "fa fa-pencil"}), "Edit Post")
                     )	
                )  
